...
c4.markdown(f'<p><a href="https://www.linkedin.com/in/obai-shaikh/"> <img src="./images/LI-In-Bug.png"'
            f'alt="linkedin.com" width="50"></a></p>')
c5.image('./images/LI-In-Bug.png', use_column_width=True)
